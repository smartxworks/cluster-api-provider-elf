...
func (in *ElfClusterSpec) DeepCopyInto(out *ElfClusterSpec) {
	*out = *in
	if in.MultiClusters != nil {
		in, out := &in.MultiClusters, &out.MultiClusters
...
func (in *ElfMachineSpec) DeepCopyInto(out *ElfMachineSpec) {
	*out = *in
	...
	if in.MultiElfClusters != nil {
		in, out := &in.MultiElfClusters, &out.MultiElfClusters
		*out = make([]MultiElfClusterConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MultiElfClusterConfig) DeepCopyInto(out *MultiElfClusterConfig) {
	*out = *in
	in.Network.DeepCopyInto(&out.Network)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MultiElfClusterConfig.
func (in *MultiElfClusterConfig) DeepCopy() *MultiElfClusterConfig {
	if in == nil {
		return nil
	}
	out := new(MultiElfClusterConfig)
	in.DeepCopyInto(out)
	return out
}
