...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ElfAuth) DeepCopyInto(out *ElfAuth) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ElfAuth.
func (in *ElfAuth) DeepCopy() *ElfAuth {
	if in == nil {
		return nil
	}
	out := new(ElfAuth)
